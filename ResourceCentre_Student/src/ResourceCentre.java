...
public class ResourceCentre {
	...
	public static void viewAllChromebook(ArrayList<Chromebook> chromebookList) {
		...
		String output = String.format("%-10s %-30s %-10s %-10s %-20s\n", "ASSET TAG", "DESCRIPTION",
				"AVAILABLE", "DUE DATE","SOFTWARE SYSTEM");
	...
	public static Chromebook inputChromebook() {	
		...
		String tag = Helper.readString("Enter asset tag > ");
		String description = Helper.readString("Enter description > ");
		String type = Helper.readString("Enter the software system > ");

		cb = new Chromebook(tag, description, type);
		return cb;
	...
	public static boolean doLoanChromebook(ArrayList<Chromebook> chromebookList, String tag, String dueDate) { // Done by: Ammar
	...
	public static void loanChromebook(ArrayList<Chromebook> chromebookList) { // Done by: Ammar
	...
	public static boolean doReturnChromebook(ArrayList<Chromebook> chromebookList,String tag){ // Done by: Ammar
		boolean isReturned = false;
		// write your code here
		for (int i = 0; i < chromebookList.size(); i++) {
			if (tag.equalsIgnoreCase(chromebookList.get(i).getAssetTag())
	...
	public static void returnChromebook(ArrayList<Chromebook> chromebookList) { // Done by: Ammar
		// write your code here
		ResourceCentre.viewAllChromebook(chromebookList);
		String tag = Helper.readString("Enter asset tag > ");
